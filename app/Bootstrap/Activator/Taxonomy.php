...
class Taxonomy {
	...
	public function register() {
		...
		$tag_labels = array(
			'name' => _x( 'Tags', 'taxonomy general name', 'niroroadmap' ),
			'singular_name' => _x( 'Tag', 'taxonomy singular name', 'niroroadmap' ),
			'search_items' =>  __( 'Search Tags', 'niroroadmap' ),
			'popular_items' => __( 'Popular Tags', 'niroroadmap' ),
			'all_items' => __( 'All Tags', 'niroroadmap' ),
			'parent_item' => null,
			'parent_item_colon' => null,
			'edit_item' => __( 'Edit Tag', 'niroroadmap' ), 
			'update_item' => __( 'Update Tag', 'niroroadmap' ),
			'add_new_item' => __( 'Add New Tag', 'niroroadmap' ),
			'new_item_name' => __( 'New Tag Name', 'niroroadmap' ),
			'separate_items_with_commas' => __( 'Separate tags with commas', 'niroroadmap' ),
			'add_or_remove_items' => __( 'Add or remove tags', 'niroroadmap' ),
			'choose_from_most_used' => __( 'Choose from the most used tags', 'niroroadmap' ),
			'menu_name' => __( 'Tags', 'niroroadmap' ),
		);
